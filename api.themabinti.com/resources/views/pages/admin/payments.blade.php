<x-app-layout>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            fetch('{{ route('admin.payments.index') }}')
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    ...
                    if (data.length === 0) {
                        container.innerHTML = '<p class="text-gray-500">No payments found.</p>';
                        return;
                    }
                    ...
                    data.forEach(payment => {
                        ...
                        row.innerHTML = `
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="/admin/payments/${payment.id}" class="text-primary hover:text-primary-dark">View</a>
                            </td>
                        `;
                ...
                .catch(error => {
                    ...
                    const container = document.getElementById('payments-container');
                    container.innerHTML = '<p class="text-red-500">Could not load payments. Please try again later.</p>';
                });
        });
    </script>
    @endpush
