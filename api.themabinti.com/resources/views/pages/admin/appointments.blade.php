<x-app-layout>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            fetch('{{ route('admin.appointments.index') }}')
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    ...
                    data.forEach(appointment => {
                        ...
                        row.innerHTML = `
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${appointment.user.name}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="/admin/appointments/${appointment.id}" class="text-primary hover:text-primary-dark">View</a>
                            </td>
                        `;
